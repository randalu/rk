                ...
                <form action="{{ route('customers.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name"
                               ...
                               value="{{ old('name') }}" placeholder="e.g. John Silva">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="phone"
                                   ...
                                   value="{{ old('phone') }}" placeholder="e.g. 0771234567">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="default_payment_term"
                            ...
                            <option value="cash"      {{ old('default_payment_term') == 'cash'      ? 'selected' : '' }}>Cash</option>
                            <option value="credit_30" {{ old('default_payment_term') == 'credit_30' ? 'selected' : '' }}>Credit 30 Days</option>
                            <option value="credit_45" {{ old('default_payment_term') == 'credit_45' ? 'selected' : '' }}>Credit 45 Days</option>
                            <option value="credit_60" {{ old('default_payment_term') == 'credit_60' ? 'selected' : '' }}>Credit 60 Days</option>
                        </select>
